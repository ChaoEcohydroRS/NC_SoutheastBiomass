...
> To quantify the potential impact of temporal mismatch, we generated Global Forest Watch (GFW; Hansen et al. 2013) and LandTrendr-based (Kennedy et al. 2010) forest disturbance layers for 2015–2022 and evaluated disturbance patterns within the 557,121 ha forest modelling domain (Supplementary Fig. S[X]). The temporal mismatch arises because FIA plots measured outside the 2018–2019 RS imagery window are paired with imagery that may not reflect their measurement-year forest state; any disturbance occurring in the gap between a plot's FIA measurement date and the imagery date introduces an inconsistency in the training data. GFW detected 64,011 ha (11.5%) and LandTrendr detected 34,749 ha (6.2%) of cumulative disturbed area over the full 2015–2022 period. Restricting to the actual mismatch window — disturbances in the pre-RS gap (2015–2017, affecting plots measured before the imagery) and the post-RS gap (2020–2022, affecting plots measured after the imagery) — the disturbed area is 8.25% (GFW) and 4.11% (LandTrendr) of the forest domain. Under the most conservative assumption (all disturbed pixels drop to zero AGB), the worst-case shift in domain-mean AGB from these gap-year disturbances is 8.06 Mg/ha (GFW) or 3.18 Mg/ha (LandTrendr) — 24% and 9% of model RMSE (34.17 Mg/ha), respectively. Both gap periods produce the same type of training inconsistency — disturbance is captured by FIA but not by the imagery, pairing a low AGB ground-truth with a higher spectral signal — so their effects on model training compound rather than cancel. The biomass-weighted disturbance fraction was 10.7% (GFW) and 4.8% (LandTrendr), lower than the area fractions because disturbance preferentially affected below-average-biomass stands in the gap years (density ratios 0.51–0.75 for the pre-RS period). Even accounting for the compounding of both gap periods, the worst-case training inconsistency remains well below model RMSE. These results confirm that while temporal mismatch between FIA measurements (2015–2022) and Sentinel-2 imagery (2018–2019) introduces a directional training effect, its magnitude is negligible relative to model RMSE and does not constitute a material source of systematic bias.
